 ...
 * @author User
 */
public class AdminFlightAdd extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 50, 330, 40));
        ...
        jPanel2.add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 100, 390, 350));

        jLabel17.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel17.setForeground(new java.awt.Color(153, 0, 0));
        jLabel17.setText("Please Enter Flight Number");
        jPanel2.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 130, 270, -1));

        jLabel18.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel18.setForeground(new java.awt.Color(153, 0, 0));
        jLabel18.setText("Please Enter Flight Name");
        ...
        try{
            ...
            if(rs.next()){
                ...
                if(jTextField1.getText().equals("") || jTextField2.getText().equals("") || d<1 || (r<1)){
                    ...
                    stmt.executeUpdate("insert into flight values("+rs.getString("max(Slno)+1")+","+jTextField1.getText()+", '"+T+"', '"+days+"', 1, '"+rate+"')");


                    AdminFlightAdd2 Add2=new AdminFlightAdd2();
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        ...
        if(jTextField1.getText().length()>6){
            jLabel17.setVisible(true);
            jLabel17.setText("Flight number has six-digits only");            
        }
        if(jTextField1.getText().length()<6){
            jLabel17.setVisible(true);
            jLabel17.setText("Flight number has six-digits");            
        }
        else{
            jLabel17.setVisible(false);
        }
...
//        this.dispose();
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        ATA.setVisible(true);
        ATA.jLabel25.setIcon(jLabel21.getIcon());
        ATA.jLabel24.setText(jLabel16.getText());
        ATA.jLabel26.setText(jLabel22.getText());        
        this.dispose();  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminFlightAdd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminFlightAdd().setVisible(true);
            }
        });
    }
