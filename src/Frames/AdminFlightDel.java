 ...
 * @author User
 */
public class AdminFlightDel extends javax.swing.JFrame {

    /**
     * Creates new form AdminTrainDel
     */
    public AdminFlightDel() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Search Your Flight by Plane Number or by Plane Name");
    ...
    //                            
                    ...
                    for(int q=0; q<rate.length(); q++){
                        ...
                        if(RateType.equals("FC")){
                            jTextArea2.append("First Class (FC)  ");
                            ...
                            jTextArea2.append("Buisness Class (BC)  ");
                            for(q=q+2;rate.charAt(q)!=',';q++){
                                Rate+=rate.charAt(q);
                            }
                            jTextArea2.append("Rs."+Rate+" \n\n");
                            ...
                            jTextArea2.append("Economic Class (EC)  ");
                            for(q=q+2;rate.charAt(q)!=',';q++){
                                Rate+=rate.charAt(q);
                            }
                            jTextArea2.append("Rs."+Rate+" \n\n");
                            ...
                            jTextArea2.append("Premium Economic Class (PEC)  ");
                            for(q=q+2;rate.charAt(q)!=',';q++){
                                Rate+=rate.charAt(q);
                            }
                            jTextArea2.append("Rs."+Rate+"\n\n");
                    ...
                    jPanel6.setVisible(false);
                    jLabel7.setText("No Such Flight found whose Flight Number is:-");
    ...
    //                            
                    ...
                    jPanel5.setVisible(true);
                    jPanel6.setVisible(false);
                    jLabel7.setText("No Such Flight found whose Flight Name is:-");
...
//        this .dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminFlightDel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminFlightDel().setVisible(true);
            }
        });
    }
