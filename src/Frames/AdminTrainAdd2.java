 ...
 * @author User
 */
public class AdminTrainAdd2 extends javax.swing.JFrame {

    /**
     * Creates new form AdminTrainAdd2
     */
    public AdminTrainAdd2() {
        initComponents();
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        if(!jTextField2.getText().equals("Nill")){
                try{
                    ...
                    stmt.executeUpdate("insert into Suggestion values('"+jTextField2.getText()+"')");
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        if(!jTextField2.getText().equals("Nill")){
            try{
                ...
                Connection cn=(Connection)DriverManager.getConnection("jdbc:mysql://localhost:"+port+"/trouvaille_destiano","root","root");
                Statement stmt=cn.createStatement();
                stmt.executeUpdate("insert into Suggestion value('"+jTextField2.getText()+"')");
                stmt.executeUpdate("insert into Suggestion value('"+jTextField1.getText()+"')"); 
                }catch(Exception e){} }
                try{
                    Class.forName("java.sql.Driver");
                    Connection cn=(Connection)DriverManager.getConnection("jdbc:mysql://localhost:"+port+"/trouvaille_destiano","root","root");
                    ...
                    AdminTrainAdd3 Add3 = new AdminTrainAdd3();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminTrainAdd2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminTrainAdd2().setVisible(true);
            }
        });
    }
