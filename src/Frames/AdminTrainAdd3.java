 ...
 * @author User
 */
public class AdminTrainAdd3 extends javax.swing.JFrame {

    /**
     * Creates new form AdminTrainAdd3
     */
    public AdminTrainAdd3() {
        initComponents();
    ...
    //                            
                    ...
                    for(int q=0; q<rate.length(); q++){
                        ...
                        if(RateType.equals("1AC")){
                            jTextArea1.append("Air-Conditioned First Class (1AC)  ");
                            ...
                            jTextArea1.append("Air-Conditioned 2-tire (2AC)  ");
                            for(q=q+2;rate.charAt(q)!=',';q++){
                                Rate+=rate.charAt(q);
                            }
                            jTextArea1.append("Rs."+Rate+" \n\n");
                            ...
                            jTextArea1.append("Air-Conditioned 3-tire (3AC)  ");
                            for(q=q+2;rate.charAt(q)!=',';q++){
                                Rate+=rate.charAt(q);
                            }
                            jTextArea1.append("Rs."+Rate+" \n\n");
                            ...
                            jTextArea1.append("Air-Conditioned Chair Class (CC)  ");
                            for(q=q+2;rate.charAt(q)!=',';q++){
                                Rate+=rate.charAt(q);
                            }
                            jTextArea1.append("Rs."+Rate+"\n\n");
                            ...
                            jTextArea1.append("Sleeper Class (SL)  ");
                            for(q=q+2;rate.charAt(q)!=',';q++){
                                Rate+=rate.charAt(q);
                            }
                            jTextArea1.append("Rs."+Rate+" \n\n");
                            ...
                            jTextArea1.append("2nd Class (2S) unreserved seating  ");
                            for(q=q+2;rate.charAt(q)!=',';q++){
                                Rate+=rate.charAt(q);
                            }
                            jTextArea1.append("Rs."+Rate);
...
int port= 3306;
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        c.setVisible(true);
        c.jLabel2.setText("New Train Added!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminTrainAdd3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminTrainAdd3().setVisible(true);
            }
        });
    }
