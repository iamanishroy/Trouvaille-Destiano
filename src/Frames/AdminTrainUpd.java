 ...
 * @author User
 */
public class AdminTrainUpd extends javax.swing.JFrame {

    /**
     * Creates new form AdminTrainUpd
     */
    public AdminTrainUpd() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton10.setText("Update Station");
        ...
        jLabel6.setText("Search Your Train by Train Number or by Train Name");
        ...
        try{
            ...
            if(rs.next()){
                ...
                if(jCheckBox15.isSelected()){
                    ...
                    stmt.executeUpdate("update train set Number = '"+jTextField1.getText()+"', Name = '"+jTextField2.getText()+"', Days =  '"+days+"',  Available = "+av+", Rate =  '"+rate+"' where Slno = '"+slno+"'");
...
//        jPanel2.setText("");
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        ...
        try{
            ...
            jPanel8.setVisible(true);
            jLabel21.setText("No Such Train found whose train Name is:-");
...
//        this.dispose();
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        ATD.setVisible(true);
        ATD.jLabel25.setIcon(jLabel25.getIcon());
        ATD.jLabel24.setText(jLabel24.getText());
        ATD.jLabel26.setText(jLabel26.getText());        
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminTrainUpd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
